  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto px-4 md:px-8 text-center">
        ...
        <blockquote className="text-xl md:text-4xl font-medium text-slate-200 leading-tight md:leading-tight">
          “There are <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-400">Other Ways</span> to see.”
        </blockquote>
